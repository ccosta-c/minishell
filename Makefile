...
SRC				= prompt.c lexer.c utils.c utils_2.c debugging.c signals.c frees.c first_checks.c lexer2.c execution.c export.c check_builtins.c execution2.c  execution_echo.c execution_echo2.c
OBJS 			:= $(SRC:.c=.o)
NAME			= minishell
