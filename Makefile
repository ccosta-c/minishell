...
SRC				= prompt.c lexer.c lst_ops.c lst_ops2.c utils.c debugging.c signals.c frees.c first_checks.c lexer2.c execution.c export.c check_builtins.c execution2.c  echo.c echo2.c utils2.c unset.c cd.c
OBJS 			:= $(SRC:.c=.o)
NAME			= minishell
